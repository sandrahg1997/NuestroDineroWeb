...
export interface Budget { id: string; household_id: string; category_id: string | null; amount: number; period_id: string; category?: Category | null; }
export interface Period { id: string; household_id: string; name: string; start_date: string; end_date: string; created_at: string; }
